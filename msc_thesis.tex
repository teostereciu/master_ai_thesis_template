...
\newtcblisting{TraceBox}{
  ...
  listing options={basicstyle=\small\ttfamily},
  sharp corners,
  title={\small\sffamily\bfseries Synthesis trace},
  coltitle=white,
...
\newtcblisting{YamlBox}{
  ...
  listing options={basicstyle=\small\ttfamily},
  sharp corners,
  title={\small\sffamily\bfseries Task specification},
  coltitle=white,
  attach boxed title to top left={xshift=6pt, yshift=-\tcboxedtitleheight/2},
...
\newtcblisting{JudgeBox}{
  ...
  listing options={basicstyle=\small\ttfamily},
  sharp corners,
  title={\small\sffamily\bfseries Judge output},
  coltitle=white,
  attach boxed title to top left={xshift=6pt, yshift=-\tcboxedtitleheight/2},
