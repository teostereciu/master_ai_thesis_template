...
Table~\ref{tab:pass_results} provides the full per-model, per-API breakdown across all eight synthesis models and three conditions; the complete matrix across all APIs and models is in Table~\ref{tab:apx:full_results} (Appendix~\ref{sec:apx:full_results}).
...
\begin{table*}[htbp]
  ...
  \scriptsize
  \begin{tabular}{l r rrr rrr rrr rrr rrr rrr rrr rrr}
    \toprule
    & & \multicolumn{6}{c}{\textbf{Base}}
    & \multicolumn{9}{c}{\textbf{Mid}}
    & \multicolumn{9}{c}{\textbf{Frontier}} \\
    \cmidrule(lr){3-8}\cmidrule(lr){9-17}\cmidrule(lr){18-26}
    & \textbf{SYNTH}
    ...
    \textbf{API} & \textbf{(D)} & D & N & M & D & N & M & D & N & M & D & N & M & D & N & M & D & N & M & D & N & M & D & N & M \\
    \midrule
    OpenWeatherMap & 100 & \textbf{100} & \textbf{100} & \textbf{100} & --- & --- & --- & \textbf{100} & 86 & \textbf{100} & 85 & 90 & 95 & 95 & 65 & 60 & \textbf{100} & 86 & \textbf{100} & \textbf{100} & 95 & \textbf{100} & --- & \textbf{100} & --- \\
    ...
    Spoonacular & 75 & 94 & 82 & \textbf{100} & --- & 60 & --- & --- & --- & --- & 83 & 91 & 90 & 93 & 79 & 86 & \textbf{100} & 90 & 78 & 80 & 82 & 60 & 93 & --- & 92 \\
  ...
  SYNTH (D) = server synthesis sufficiency, docs condition, GPT-5.2 reference model.
