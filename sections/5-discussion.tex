...
This chapter interprets the empirical findings in light of the research questions and prior work. Section~\ref{sec:discussion-synthesis} discusses the general feasibility of synthesis; Section~\ref{sec:discussion-gravity} examines the parametric gravity mechanism; Section~\ref{sec:discussion-probing} presents the logit-lens probing analysis; Section~\ref{sec:discussion-proxy} discusses SYNTH as a proxy metric; Section~\ref{sec:discussion-guidelines} derives practical guidelines; and Section~\ref{sec:discussion-priorwork} positions the findings relative to prior work. Limitations are addressed in Section~\ref{sec:discussion-limitations}.
...
within a single synthesis context. This is consistent with findings on positional bias in long contexts~\citep{liu2023lostmiddle,disentanglerecall2025},
...
WAPIIBench~\citep{wapiibench2025} catalogues LLM-generated API integration errors against live services and reports error taxonomies that partially overlap with our failure cause categories (\textsc{tool\_schema},
