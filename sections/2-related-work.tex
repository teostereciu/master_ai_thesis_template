...
\centering
\scriptsize
\caption{Positioning relative to prior work. \emph{Tool synth.}: executable tool creation from documentation. \emph{Doc faith.}: output grounded in provided documentation. \emph{Mech.\ analysis}: internal representation probing.}
\label{tab:related}
