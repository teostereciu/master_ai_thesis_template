...
\centering
\scriptsize
\caption{Positioning relative to prior benchmarks. Positioning relative to prior work. \emph{Tool synth.}: executable tool creation. \emph{Doc faith.}: output grounded in provided documentation. \emph{Mech. Analysis}: internal representation probing.}
\label{tab:related}
