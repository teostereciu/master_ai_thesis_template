...
This chapter reviews and positions the literature across five domains. Section~\ref{sec:related_work:tools} covers tool use and tool synthesis; Section~\ref{sec:related_work:code_gen} covers code generation with live API execution. Sections~\ref{sec:related_work:context} and~\ref{sec:related_work:param_conflict} address the core empirical phenomenon we characterise --- in-context learning and parametric knowledge conflicts. Section~\ref{sec:related_work:mechanistic} provides the mechanistic basis for our logit-lens probing; Section~\ref{sec:related_work:mcp} introduces MCP. Table~\ref{tab:related} summarises our positioning relative to prior work.
