...
run locally via a vLLM inference server, allowing comparison of instruction-tuned
versus base model synthesis behaviour. These span a range of training
...
Qwen3-Coder-Next     & Qwen3           & vLLM (local) & Subset, all conditions \\
Qwen3-Coder-Next-Base & Qwen3          & vLLM (local) & Subset, all conditions \\
\bottomrule
\end{tabular}
\end{table}
