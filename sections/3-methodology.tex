...
\centering
\small
\caption{Synthesis models evaluated. \emph{Coverage}: datasets and conditions
on which the model is run. \emph{Access}: API provider or local inference.}
\label{tab:models}
\setlength{\tabcolsep}{5pt}
\begin{tabular}{llll}
\toprule
\textbf{Model} & \textbf{Family} & \textbf{Access} & \textbf{Coverage} \\
\midrule
GPT-5.2              & OpenAI GPT-5    & Azure API     & All 14 APIs, all conditions \\
GPT-5.4              & OpenAI GPT-5    & Azure API     & All 14 APIs, all conditions \\
Sonnet~4.6           & Anthropic Claude & GCP API      & Subset, all conditions \\
Haiku~4.5            & Anthropic Claude & GCP API      & Subset, all conditions \\
Gemini~3.1~Pro       & Google Gemini   & GCP API       & Subset, all conditions \\
Qwen3-Coder-Next     & Qwen3           & vLLM (2$\times$H100) & Subset, all conditions \\
Qwen3-Coder-Next-Base & Qwen3          & vLLM (2$\times$H100) & Subset, all conditions \\
\bottomrule
\end{tabular}
\end{table}
