...
simplest APIs; per-model results are in Table~\ref{tab:pass_results} and Table~\ref{tab:apx:full_results}. Gemini~2.5~Pro and Gemini~3.5~Flash both exhibited an
