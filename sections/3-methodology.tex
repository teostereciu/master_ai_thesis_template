...
We evaluate five synthesis models spanning three model families and two
...
Sonnet~4.6 (Claude Sonnet) is run across a representative subset of APIs.
Gemini~3.1~Pro provides a third model family for comparison. Qwen3-Coder-Next
is run locally via a vLLM inference server. These span a range of training
...
Sonnet~4.6     & Anthropic Claude & GCP API        & Subset of APIs, all conditions \\
Gemini~3.1~Pro & Google Gemini   & GCP API         & Subset of APIs, all conditions \\
Qwen3-Coder-Next & Qwen3       & vLLM (local)    & Subset of APIs, all conditions \\
\bottomrule
\end{tabular}
\end{table}
