...
GPT-5.4 and GPT-5.4-mini are evaluated as more recent OpenAI baselines; GPT-5.4-mini was run on a pilot three-API set (GitHub, Stripe, Zulip) and aborted after confirming uniformly weak results across all conditions. Sonnet~4.6 and Haiku~4.5 (both Anthropic Claude) offer a strong/efficient tradeoff within the same model family. Gemini~3.1~Pro provides a third model family. Qwen3-Coder-Next and its base variant Qwen3-Coder-Next-Base are
